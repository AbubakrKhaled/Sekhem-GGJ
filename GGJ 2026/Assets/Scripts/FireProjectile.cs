...
/// <summary>
/// Fire projectile for Mage Level 3
/// Part of radial burst attack - shoots outward from player in all directions
/// </summary>
public class FireProjectile : MonoBehaviour
{
    ...
    private float lifetime = 3f; // Shorter lifetime than water (less range)
